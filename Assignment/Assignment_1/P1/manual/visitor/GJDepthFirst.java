...
public class GJDepthFirst implements GJVisitor<String, String> {
   ...
   public String visit(MethodDeclaration n, String argu) {
      String _ret = null;
      HashMap<String, Integer> copy = new HashMap<>(varMap);
      inMethod = true;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      // n.f2.accept(this, argu);
   ...
   public String visit(AssignmentStatement n, String argu) {
      ...
      n.f1.accept(this, argu);
      if (varMap.containsKey(var) && varMap.get(var) == 2) {
         final_issue = true;
         return _ret;
      }
      n.f2.accept(this, argu);
   ...
   public String visit(ForStatement n, String argu) {
      ...
      if (varMap.containsKey(init) && varMap.get(init) == 2) {
         final_issue = true;
         return _ret;
      }
      varMap.put(init, 1);
      ...
      n.f10.accept(this, argu);
      n.f11.accept(this, argu);
      if (varMap.containsKey(loop) && varMap.get(loop) == 2) {
         final_issue = true;
      }
      varMap = copyMap;
      return _ret;
